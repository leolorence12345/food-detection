...
# Configuration
REGION="us-east-1"
ECR_REPO_NAME="nutrition-video-analysis-dev-video-processor"
...
echo "     --cluster nutrition-video-analysis-dev-cluster \\"
echo "     --service nutrition-video-analysis-dev-video-processor \\"
echo "     --force-new-deployment \\"
echo "     --region ${REGION}"
echo ""
echo "2. Monitor ECS logs:"
echo "   aws logs tail /aws/ecs/nutrition-video-analysis-dev-video-processor --follow --region ${REGION}"
echo ""
